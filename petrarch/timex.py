...
#Code pulled from the NLTK-contrib functions:
#https://code.google.com/p/nltk/source/browse/trunk/nltk_contrib/

#Web address this code was pulled from is:
#https://code.google.com/p/nltk/source/browse/trunk/nltk_contrib/nltk_contrib/timex.py

#Written by StevenBird and "ehk"
